...
#include "G01UserFacingExperienceDefinition.generated.h"
...
class UG01UserFacingExperienceDefinition : public UPrimaryDataAsset
{
	GENERATED_BODY()
public:
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = Experience, meta = (AllowedTypes = "G01ExperienceDefinition"))
