...
#include UE_INLINE_GENERATED_CPP_BY_NAME(G01ExperienceDefinition)

#define LOCTEXT_NAMESPACE "CommonExperience"

UG01ExperienceDefinition::UG01ExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UG01ExperienceDefinition::IsDataValid(FDataValidationContext& Context) const
{
...
void UG01ExperienceDefinition::UpdateAssetBundleData()
{
