...
#include "G01UserFacingExperienceDefinition.h"
#include "CommonSessionSubsystem.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(G01UserFacingExperienceDefinition)

UCommonSession_HostSessionRequest* UG01UserFacingExperienceDefinition::CreateHostingRequest(const UObject* WorldContextObject) const
{
