...
#include "G01AbilityTagRelationshipMapping.generated.h"

USTRUCT()
struct FG01AbilityTagRelationship
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class G01_API UG01AbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
};
