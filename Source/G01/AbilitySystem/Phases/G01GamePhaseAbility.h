...
#include "G01GamePhaseAbility.generated.h"

/**
 * 
 */
UCLASS()
class G01_API UG01GamePhaseAbility : public UG01GameplayAbility
{
	GENERATED_BODY()
public:

	UG01GamePhaseAbility(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
