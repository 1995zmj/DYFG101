...
#include "UI/Common/G01TabListWidgetBase.h"

#include "CommonAnimatedSwitcher.h"
#include "CommonButtonBase.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(G01TabListWidgetBase)

void UG01TabListWidgetBase::NativeOnInitialized()
{
	Super::NativeOnInitialized();
}

void UG01TabListWidgetBase::NativeConstruct()
{
...
void UG01TabListWidgetBase::NativeDestruct()
{
	for (FG01TabDescriptor& TabInfo : PreregisteredTabInfoArray)
	{
...
bool UG01TabListWidgetBase::GetPreregisteredTabInfo(const FName TabNameId, FG01TabDescriptor& OutTabInfo)
{
	const FG01TabDescriptor* const FoundTabInfo = PreregisteredTabInfoArray.FindByPredicate([&](FG01TabDescriptor& TabInfo) -> bool
		{
...
void UG01TabListWidgetBase::SetTabHiddenState(FName TabNameId, bool bHidden)
{
	for (FG01TabDescriptor& TabInfo : PreregisteredTabInfoArray)
	{
...
bool UG01TabListWidgetBase::RegisterDynamicTab(const FG01TabDescriptor& TabDescriptor)
{
...
void UG01TabListWidgetBase::HandlePreLinkedSwitcherChanged()
{
	for (const FG01TabDescriptor& TabInfo : PreregisteredTabInfoArray)
	{
...
void UG01TabListWidgetBase::HandlePostLinkedSwitcherChanged()
{
...
void UG01TabListWidgetBase::HandleTabCreation_Implementation(FName TabId, UCommonButtonBase* TabButton)
{
	FG01TabDescriptor* TabInfoPtr = nullptr;

	FG01TabDescriptor TabInfo;
	...
	if (TabButton->GetClass()->ImplementsInterface(UG01TabButtonInterface::StaticClass()))
	{
		...
		{
			IG01TabButtonInterface::Execute_SetTabLabelInfo(TabButton, *TabInfoPtr);
		}
	}
...
bool UG01TabListWidgetBase::IsFirstTabActive() const
{
...
bool UG01TabListWidgetBase::IsLastTabActive() const
{
	if (PreregisteredTabInfoArray.Num() > 0)
	{
...
bool UG01TabListWidgetBase::IsTabVisible(FName TabId)
{
...
int32 UG01TabListWidgetBase::GetVisibleTabCount()
{
	int32 Result = 0;
...
void UG01TabListWidgetBase::SetupTabs()
{
	for (FG01TabDescriptor& TabInfo : PreregisteredTabInfoArray)
	{
		if (TabInfo.bHidden)
