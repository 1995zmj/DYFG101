...
#include "UI/Common/G01BoundActionButton.h"
#include "CommonInputSubsystem.h"
#include UE_INLINE_GENERATED_CPP_BY_NAME(G01BoundActionButton)


class UCommonButtonStyle;

void UG01BoundActionButton::NativeConstruct()
{
...
void UG01BoundActionButton::HandleInputMethodChanged(ECommonInputType NewInputMethod)
{
