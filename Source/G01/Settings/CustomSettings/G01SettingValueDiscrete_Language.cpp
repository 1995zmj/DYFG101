#include "G01SettingValueDiscrete_Language.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(G01SettingValueDiscrete_Language)
...
UG01SettingValueDiscrete_Language::UG01SettingValueDiscrete_Language()
{
}

void UG01SettingValueDiscrete_Language::OnInitialized()
{
	Super::OnInitialized();
...
void UG01SettingValueDiscrete_Language::StoreInitial()
{
	// ?
}

void UG01SettingValueDiscrete_Language::OnApply()
{
...
void UG01SettingValueDiscrete_Language::ResetToDefault()
{
	SetDiscreteOptionByIndex(SettingSystemDefaultLanguageIndex);
}

void UG01SettingValueDiscrete_Language::RestoreToInitial()
{
	if (UG01SettingsShared* Settings = CastChecked<UG01LocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
void UG01SettingValueDiscrete_Language::SetDiscreteOptionByIndex(int32 Index)
{
	if (UG01SettingsShared* Settings = CastChecked<UG01LocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
int32 UG01SettingValueDiscrete_Language::GetDiscreteOptionIndex() const
{
	if (const UG01SettingsShared* Settings = CastChecked<UG01LocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
TArray<FText> UG01SettingValueDiscrete_Language::GetDiscreteOptions() const
{
