...
#include "G01SettingValueDiscreteDynamic_AudioOutputDevice.generated.h"
...
UCLASS()
class UG01SettingValueDiscreteDynamic_AudioOutputDevice : public UGameSettingValueDiscreteDynamic
{
	GENERATED_BODY()

public:

	virtual ~UG01SettingValueDiscreteDynamic_AudioOutputDevice() = default;
