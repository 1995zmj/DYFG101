...
UGameSettingCollection* UG01GameSettingRegistry::InitializeGameplaySettings(UG01LocalPlayer* InLocalPlayer)
{
...

	{
		...
		//----------------------------------------------------------------------------------
		{
			UG01SettingValueDiscrete_Language* Setting = NewObject<UG01SettingValueDiscrete_Language>();
