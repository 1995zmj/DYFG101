...
#include "G01SettingsListEntrySetting_KeyboardInput.generated.h"

class UKeyAlreadyBoundWarning;

class UGameSetting;
class UGameSettingPressAnyKey;
class UG01ButtonBase;
class UG01SettingKeyboardInput;
class UObject;
...
class UG01SettingsListEntrySetting_KeyboardInput : public UGameSettingListEntry_Setting
{
	GENERATED_BODY()
...
protected:
	UPROPERTY()
	TObjectPtr<UG01SettingKeyboardInput> KeyboardInputSetting;
...
private:	// Bound Widgets
	...
	TObjectPtr<UG01ButtonBase> Button_PrimaryKey;

	UPROPERTY(BlueprintReadOnly, meta = (BindWidget, BlueprintProtected = true, AllowPrivateAccess = true))
	TObjectPtr<UG01ButtonBase> Button_SecondaryKey;

	UPROPERTY(BlueprintReadOnly, meta = (BindWidget, BlueprintProtected = true, AllowPrivateAccess = true))
	TObjectPtr<UG01ButtonBase> Button_Clear;

	UPROPERTY(BlueprintReadOnly, meta = (BindWidget, BlueprintProtected = true, AllowPrivateAccess = true))
	TObjectPtr<UG01ButtonBase> Button_ResetToDefault;
};
