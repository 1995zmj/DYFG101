...
#include "G01GameFeaturePolicy.generated.h"
...
class UG01GameFeaturePolicy : public UDefaultGameFeaturesProjectPolicies
{
	GENERATED_BODY()

public:
	static UG01GameFeaturePolicy& Get();

	UG01GameFeaturePolicy(const FObjectInitializer& ObjectInitializer);
